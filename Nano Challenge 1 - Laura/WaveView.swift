...
class WaveView: UIView {
    ...
    */
    ...
    let preferredColor = UIColor(named: "blue")?.cgColor
            ...
            override func draw(_ rect: CGRect) {
                ...
                let height = Double(self.frame.height - 880)
                ...
                myLayer.fillColor = preferredColor
                myLayer.strokeColor = preferredColor
